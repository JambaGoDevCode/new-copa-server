/*
  ...
  - You are about to drop the column `is` on the `Pool` table. All the data in the column will be lost.
...
CREATE TABLE "new_Pool" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "ownwerId" TEXT,
    CONSTRAINT "Pool_ownwerId_fkey" FOREIGN KEY ("ownwerId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Pool" ("code", "createdAt", "title") SELECT "code", "createdAt", "title" FROM "Pool";
DROP TABLE "Pool";
